...
export type WACIElementProps = AlwaysButtonWACIElementProp | AlwaysQRWACIElementProp | DetectionWACIElementProp

export const WACIElement: FC<WACIElementProps> = ({ mode: _mode, ...props }) => {
  const mode = useMemo<'qr' | 'button'>(() => {
    ...
    const isMobilePlatform = parsedResult.platform.type === 'mobile' || parsedResult.platform.type === 'tablet'
    const isMobileOS = parsedResult.os.name === 'iOS' || parsedResult.os.name === 'Android'
