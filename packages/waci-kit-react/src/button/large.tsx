...
const Style: FC<{ baseId: string; type: LargeButtonType }> = ({ baseId, type }) => {
...
const LockIcon: FC<{ baseId: string }> = (props) => (
  <svg viewBox="0 0 24 24" id={`${props.baseId}-lock`}>
    <path
...
export const LargeButtonContent: FC<{
  baseId: string
  type: LargeButtonType
}> = (props) => {
  return (
    <>
      <Style baseId={props.baseId} type={props.type} />
      <LockIcon baseId={props.baseId} />
      <TextAndLogo baseId={props.baseId} type={props.type} />
    </>
  )
}
