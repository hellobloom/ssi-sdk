import { EmailPersonV2, VCEmailPersonV2Type, getVCEmailPersonV2Context } from '../../email/v2'
import { expandVCV2 } from '../__fixtures__'

describe('VCEmailPersonV2', () => {
  it('expands correctly', async () => {
    const expanded = await expandVCV2<VCEmailPersonV2Type, EmailPersonV2>({
      type: 'EmailCredentialPersonV2',
      data: {
        '@type': 'EmailPerson',
        email: 'bob.belcher@gmail.com',
      },
      context: getVCEmailPersonV2Context(),
    })
    ...
    expect(expanded).toMatchInlineSnapshot(`
      Object {
        ...
        "@type": Array [
          ...
          "https://schema.bloom.co/EmailCredentialPersonV2",
        ],
        "https://www.w3.org/2018/credentials#credentialSubject": Array [
          Object {
            "https://schema.bloom.co/data": Array [
              Object {
                "@type": Array [
                  "https://schema.bloom.co/EmailPerson",
                ],
                "https://schema.org/email": Array [
                  Object {
                    "@value": "bob.belcher@gmail.com",
                  },
                ],
              },
            ],
