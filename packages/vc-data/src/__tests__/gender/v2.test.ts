import { GenderPersonV2, VCGenderPersonV2Type, getVCGenderPersonV2Context } from '../../gender/v2'
import { expandVCV2 } from '../__fixtures__'

describe('VCGenderPersonV2', () => {
  it('expands correctly', async () => {
    const expanded = await expandVCV2<VCGenderPersonV2Type, GenderPersonV2>({
      type: 'GenderCredentialPersonV2',
      data: {
        '@type': 'GenderPerson',
        gender: 'Male',
      },
      context: getVCGenderPersonV2Context(),
    })
    ...
    expect(expanded).toMatchInlineSnapshot(`
      Object {
        ...
        "@type": Array [
          ...
          "https://schema.bloom.co/GenderCredentialPersonV2",
        ],
        "https://www.w3.org/2018/credentials#credentialSubject": Array [
          Object {
            "https://schema.bloom.co/data": Array [
              Object {
                "@type": Array [
                  "https://schema.bloom.co/GenderPerson",
                ],
