...
export type ImmunizationV1 = CreateThing<
  ...
  R4.IImmunization & {
    ...
    patient: OneOrMore<R4.IReference | R4.IPatient>
    encounter: OneOrMore<R4.IReference | R4.IEncounter>
    occurrenceDateTime: string
    primarySource: boolean
    location: OneOrMore<R4.IReference | R4.ILocation>
    manufacturer: OneOrMore<R4.IReference | R4.IOrganization>
    lotNumber: string
...
export type ObservationV1 = CreateThing<
  ...
  R4.IObservation & {
    ...
    device: OneOrMore<R4.IReference | R4.IDevice | R4.IDeviceMetric>
    code: R4.ICodeableConcept
    subject: OneOrMore<R4.IReference | R4.IPatient | R4.IGroup | R4.IDevice | R4.ILocation>
    effectiveDateTime: string
    performer: OneOrMore<
      R4.IReference | R4.IPractitioner | R4.IPractitionerRole | R4.IOrganization | R4.ICareTeam | R4.IPatient | R4.IRelatedPerson
    >
...
export type VCSImmunizationV1 = ExtendableVCSubject<ImmunizationV1>
export type VCSObservationV1 = ExtendableVCSubject<ObservationV1>
export type VCSPatientV1 = ExtendableVCSubject<FHIRPatientE>
...
export type VCSHealthPassportBundleV1 = ExtendableVCSubject<FHIRBundleContainer>

export type VCHealthPassportImmunizationV1 = ExtendableVC<VCSHealthPassportImmunizationV1, 'HealthPassportImmunizationCredentialV1'>
export type VCHealthPassportObservationV1 = ExtendableVC<VCSHealthPassportObservationV1, 'HealthPassportObservationCredentialV1'>
export type VCHealthPassportGeneralV1 = ExtendableVC<VCSHealthPassportGeneralV1, 'HealthPassportGeneralCredentialV1'>
export type VCHealthPassportBundleV1 = ExtendableVC<VCSHealthPassportBundleV1, 'HealthPassportBundleCredentialV1'>
...
export const getVCHealthPassportBundleV1Context = () => {
  ...
  const bundleContainerEntry = createContextEntry<FHIRBundleContainer>({
    ...
    fields: {
      fhirVersion: 'bloomSchema',
      fhirBundle: 'bloomSchema',
    },
  })
