...
export type WACIChallengeJWTPayload<
...
export type OfferChallengeJWTPayloadV1 = WACIChallengeJWTPayload<
  '1',
  'offer'
> & {
...
export type RequestChallengeJWTPayloadV1 = WACIChallengeJWTPayload<
  '1',
  'request'
> & {
